...
import com.vogella.android.rxjava.instaclone.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public static final String APP_TAG = "IGClone";
    ...
    private void launchCamera() {
        ...
        photoFile = getPhotoFileUri(photoFileName + "_" + etDescription.getText().toString());
